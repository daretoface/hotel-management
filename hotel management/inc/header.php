<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">RADISSON</a>
            ...
            <form>
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <a href="javscript: void(0)" class="text-secondary text-decoration-none">Forgot Password?</a>
                    </div>
                </div>
            </form>
        </div>
