...
<body class="bg-light">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12 text-center mt-5">
        <ahref="#" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none"> More Rooms >>>></a>
      </div>
    </div>
  </div>
  ...
  <h2 class="pt-4 mb-4 text-center fw-bold h-font">OUR FACILITIES</h2>
  ...
  <!-- testimonials -->
  <h2 class="pt-4 mb-4 text-center fw-bold h-font">TESTIMONIALS</h2>
      ...
      <div class="swiper-wrapper mb-5">
        <div class="swiper-slide bg-white p-4">
          ...
          <p>
            ...
            Dignissimos, voluptatem enim doloremque iste corrupti repellat ex
            reiciendis ipsa quos unde!
          </p>
          <div class="rating">
            <i class="bi bi-star-fill text-warning"></i>
            <i class="bi bi-star-fill text-warning"></i>
